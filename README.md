...
When you put text on a picture, stroke(outline) can make text more
readable
...
![](assets/2025-12-09-14-01-17.png) (the SelectableStrokeTextblock in
the lower right corner or the picture is not usable yet)
...
you can directly copy it to your project and use it without reference
this project
